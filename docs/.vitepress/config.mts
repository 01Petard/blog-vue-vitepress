            ...
            '/开发/': [
                {
                    ...
                    items: [
                        ...
                        {
                            text: "Intellij IDEA fileTemplates文件模板",
                            link: "/开发/Intellij%20IDEA%20fileTemplates文件模板"
                        },
                        ...
                        {text: "Nginx的配置和使用命令", link: "/开发/Nginx的配置和使用命令"},
                        {
                            ...
                            items: [
                                {
                                    text: 'Spring注解——缓存、定时任务、异步任务',
                                    link: '/开发/后端/Spring注解——缓存、定时任务、异步任务'
                                },
                                {
                                    text: 'Function Call的实现与调用链分析',
                                    link: '/开发/后端/Function%20Call的实现与调用链分析'
                                },
                                {text: '常见后端框架性能对比（纯主观）', link: '/开发/后端/常见后端框架性能对比（纯主观）'},
                                {
                                    text: '详解微信小程序的注册、登录和支付的实现',
                                    link: '/开发/后端/详解微信小程序的注册、登录和支付的实现'
                                },
                                {
                                    text: '低、中、高并发情况下的库存扣减处理方案',
                                    link: '/开发/后端/低、中、高并发情况下的库存扣减处理方案'
                                },
                                {
                                    text: 'LangChain4j大模型对话应用快速入门',
                                    link: '/开发/后端/LangChain4j大模型对话应用快速入门'
                                },
                                {
                                    text: "如何微调大模型并暴露接口给后端调用",
                                    link: "/开发/后端/如何微调大模型并暴露接口给后端调用"
                                },
                                {text: '使用ANSI编码控制终端日志颜色', link: '/开发/后端/使用ANSI编码控制终端日志颜色'},
                                {
                                    text: '字符串校验中isBlank、isEmpty、isNull怎么用',
                                    link: '/开发/后端/字符串校验中isBlank、isEmpty、isNull怎么用'
                                },
                                {text: '商城系统经典问题分析', link: '/开发/后端/商城系统经典问题分析'},
                                {text: 'JMeter快速上手指南', link: '/开发/后端/JMeter快速上手指南'},
                                {
                                    text: '高并发系统发现Redis热点数据几种实现方式',
                                    link: '/开发/后端/高并发系统发现Redis热点数据几种实现方式'
                                },
                                {
                                    text: '常被忽视的“外键约束”和“唯一约束”',
                                    link: '/开发/后端/常被忽视的“外键约束”和“唯一约束”'
                                },
                                {text: 'JSR303数据校验指南', link: '/开发/后端/JSR303数据校验指南'},
                                {
                                    text: 'MyBatis-Plus动态拼接简化SQL操作',
                                    link: '/开发/后端/MyBatis-Plus动态拼接简化SQL操作'
                                },
                                {text: 'record的使用说明', link: '/开发/后端/record的使用说明'},
                                {
                                    text: '如何保证redis中的数据都是热点数据',
                                    link: '/开发/后端/如何保证redis中的数据都是热点数据'
                                },
                                {
                                    text: '类ChatGPT模型的请求与返回参数详解',
                                    link: '/开发/后端/类ChatGPT模型的请求与返回参数详解'
                                },
                                ...
                                {
                                    text: '阿里云OSS和内容安全Java实现参考代码',
                                    link: '/开发/后端/阿里云OSS和内容安全Java实现参考代码'
                                },
                                ...
                                {
                                    text: "SpringMVC注解和配置 + fastjson的简单使用",
                                    link: "/开发/后端/SpringMVC注解和配置+fastjson的简单使用"
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    text: "My Java Guide - 计算机基础",
                                    link: "/开发/My Java Guide/My Java Guide - 计算机基础"
                                },
                                {
                                    text: "My Java Guide - Java基础",
                                    link: "/开发/My Java Guide/My Java Guide - Java基础"
                                },
            ...
            '/软件/': [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    text: "Ubuntu部署Jenkins并实现前后端的自动化构建与部署",
                                    link: "/软件/Linux/Ubuntu部署Jenkins并实现前后端的自动化构建与部署"
                                },
                                {text: "Ubuntu上固定无线的IP地址", link: "/软件/Linux/Ubuntu上固定无线的IP地址"},
                                {text: "Ubuntu部署项目流程完整版", link: "/软件/Linux/Ubuntu部署项目流程完整版"},
                                {
                                    text: "Atlassian家族软件部署安装指南",
                                    link: "/软件/Linux/Atlassian家族软件部署安装指南"
                                },
                                ...
                                {
                                    text: "Jira和Confluence安装和配置记录",
                                    link: "/软件/Linux/Jira和Confluence安装和配置记录"
                                },
                                {text: "通过WebHook实现简易版CICD", link: "/软件/通过WebHook实现简易版CICD"},
                                {text: "简易的GitLab CICD实现思路", link: "/软件/Linux/简易的GitLab CICD实现思路"},
                                {
                                    text: "解决MySQL和Redis远程连接问题",
                                    link: "/软件/Linux/解决MySQL和Redis远程连接问题"
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                {
                                    text: "切换jdk版本的方法（环境变量法）",
                                    link: "/软件/Linux/切换jdk版本的方法（环境变量法）"
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    text: "windows上重要的垃圾清理目录",
                                    link: "/软件/Windows/windows上重要的垃圾清理目录"
                                },
                                ...
                                {
                                    text: "win批量删除特定格式开头的文件",
                                    link: "/软件/Windows/win批量删除特定格式开头的文件"
                                },
                                {text: "Windows上解决端口占用", link: "/软件/Windows/Windows上解决端口占用"},
                                {
                                    text: "winWindows11安装卸载安卓软件",
                                    link: "/软件/Windows/winWindows11安装卸载安卓软件"
                                },
                            ]
                        },
                        {
                            ...
                            items: [
                                ...
                                {
                                    text: "conda创建虚拟环境，安装Pytorch",
                                    link: "/软件/Python/conda创建虚拟环境，安装Pytorch"
                                },
                                {
                                    text: "解决Anaconda安装后命令行前出现(base)",
                                    link: "/软件/Python/解决Anaconda安装后命令行前出现(base)"
                                },
                                {
                                    text: "jupyter相关",
                                    collapsed: false,
                                ...
                                {
                                    text: "Pytorch下载配置，Anaconda创建虚拟环境",
                                    link: "/软件/Python/Pytorch下载配置，Anaconda创建虚拟环境"
                                },
