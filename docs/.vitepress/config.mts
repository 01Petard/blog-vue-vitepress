          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {text: "uv入门使用指南", link: "/软件/Python/uv入门使用指南"},
                {text: "uv项目使用指南", link: "/软件/Python/uv项目使用指南"},
      ...
      '/杂谈/': [
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                {text: "开发信息备忘录_shinemo", link: "/开发/开发信息备忘录_shinemo"},
                {text: "鹰瞳Airdoc第三方对接文档总结", link: "/开发/鹰瞳Airdoc第三方对接文档总结"},
                {text: "开发信息备忘录_airdoc", link: "/开发/开发信息备忘录_airdoc"},
                {text: "开发信息备忘录_sunnybaer", link: "/开发/开发信息备忘录_sunnybaer"},
