...
🧱 2. **选择类排序（Selection Sort）**

每次从未排序区选出最小/最大值，放到目标位置。

| 算法名   | 特点                                          |
| -------- | --------------------------------------------- |
| 选择排序 | 简单、不稳定                                  |
| 堆排序   | 用堆结构选最大/最小，**原地排序**，**不稳定** |

🧩 3. **插入类排序（Insertion Sort）**
...
| 算法名  | 特点                                                         |
| ------- | ------------------------------------------------------------ |
| Timsort | Java 和 Python 的默认排序算法，**归并 + 插入优化**，非常高效 |
